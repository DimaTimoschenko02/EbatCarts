...
const PARAM_DESCRIPTORS: ParamDescriptor[] = [
  ...
  { key: "stationarySteerThreshold", group: "Рулёжка", min: 0.5, max: 5, step: 0.25, unit: "m/s",
    short: "На какой скорости включается хак 'поворот на месте' (см. stationaryOmegaKick ниже). Ниже этой скорости он активен, выше — гаснет плавно." },
  ...
  { key: "stationaryOmegaKick", group: "Bicycle v3.0", min: 0, max: 8, step: 0.25, unit: "rad/s²",
    short: "Аркадная помощь при развороте на месте (bicycle-модель сама по себе не крутит стоящую машину). 0 — чистая физика, 2.5 — разворот за ~1с, 6+ — вертится волчком." },
  ...
  { key: "corneringDragCoeff", group: "Дрифт: сигналы и эффекты", min: 0.0, max: 30.0, step: 0.5, unit: "",
    short: "Доп. торможение в поворотах поверх emergent-замедления от шин. 0 — только emergent, 15+ — машинка 'закапывается' в круг, скорость падает быстро." },
  ...
  { key: "driftSpeedGateLo", group: "Дрифт v4.0 (continuous)", min: 0.5, max: 15, step: 0.5, unit: "m/s",
    short: "Нижняя граница скорости для 'ворот' дрифта — ниже неё сигнал гасится, даже при полном руле. Защита от дрифта на парковочной скорости." },
  { key: "driftSpeedGateHi", group: "Дрифт v4.0 (continuous)", min: 1, max: 25, step: 0.5, unit: "m/s",
    short: "Верхняя граница скорости для 'ворот' дрифта — выше неё сигнал уже не растёт от скорости, только от руля/газа." },
  ...
  { key: "driftEngageInRate", group: "Дрифт v4.0 (continuous)", min: 1.0, max: 15.0, step: 0.5, unit: "/s",
    short: "Как быстро дрифт-сигнал нарастает на ВХОДЕ. 1.5 — мягкий fade-in (~0.5с+), 3.5 — комфортно, 8+ — резкий щелчок в дрифт." },
  { key: "driftEngageOutRate", group: "Дрифт v4.0 (continuous)", min: 0.5, max: 10.0, step: 0.25, unit: "/s",
    short: "Как быстро дрифт-сигнал затухает на ВЫХОДЕ. Обычно чуть медленнее engageInRate — резкое выключение ощущается как обрыв, плавное даёт 'послевкусие' заноса." },
