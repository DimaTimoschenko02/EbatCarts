...
| 6 | Kart Physics | Core | 2 | MVP | v3.1 Implemented in Godot (frozen reference). Live development in web-slice TS port: Continuous Drift v4.0 + v4.1 feel tuning по покадровому сравнению с оригиналом + owner-approved дефолты («лучшая версия езды», круг 126.8°/с ≈ эталон; 2026-07-08, коммиты 3ee62f1/fa1da99, drift-circle regression guard в тестах) — см. reference-videos/README.md |
